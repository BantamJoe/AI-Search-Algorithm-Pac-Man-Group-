...
public class GameManager : MonoBehaviour {
    ...
    public static int starspawn = 0;
    public static int starspawncheck = 0;
    ...
    void OnLevelWasLoaded()
    {
        ...
        clyde.GetComponent<GhostMove>().speed += (Level/2) * SpeedPerLevel/2;
        blinky.GetComponent<GhostMove>().speed += (Level / 2) * SpeedPerLevel;
        pinky.GetComponent<GhostMove>().speed += (Level / 2) * SpeedPerLevel;
        inky.GetComponent<GhostMove>().speed += (Level / 2) * SpeedPerLevel;
